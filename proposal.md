EA Portfolio System – Implementation
Proposal v2.0
...
● SK3_DD_MAX = 0.30
Reason:
This may be caused by temporary regime mismatch and should not be treated as irreversible
failure.
...
Reason:
Single-trade shock may reflect market condition mismatch or abnormal volatility, not
necessarily permanent structural failure.
...
II. Phase 2 – Regime-Aware Exposure
Adjustment
1. Objective
...
𝑇𝑟𝑒𝑛𝑑𝑆𝑐𝑜𝑟𝑒 = 𝐴𝑣𝑔(𝐴𝐷𝑋14)
Volatility Score
Use:
𝑉𝑜𝑙𝑎𝑡𝑖𝑙𝑖𝑡𝑦𝑆𝑐𝑜𝑟𝑒 = 𝐴𝑣𝑔(𝐴𝑇𝑅(14)/𝐴𝑇𝑅(100))
4. Regime Labels
...
This produces a Regime Compatibility score, but it should be used only as an input to
exposure ranking.
...
Example:
Regime Compatibility Exposure Weight
Strong 1.3
Neutral 1.0
Weak 0.7
Very Weak 0.4
This weight is passed into Phase 3.
III. Phase 3 – Health Score & Capital
Allocation
1. Objective
Phase 3 determines:
...
Metric Weight
Profit Factor (PF) 25%
Recovery Factor (RF) 25%
Regime Compatibility (RC) 20%
Max Drawdown Safety 15%
Equity Smoothness (ES) 15%
Formula:
𝐻𝑒𝑎𝑙𝑡ℎ𝑆𝑐𝑜𝑟𝑒 = 0. 25𝑃𝐹 + 0. 25𝑅𝐹 + 0. 20𝑅𝐶 + 0. 15𝑀𝑎𝑥𝐷𝐷 + 0. 15𝐸𝑆
...
< 20 0.0
8. Final Lot Formula
𝐹𝑖𝑛𝑎𝑙𝐿𝑜𝑡 = 𝐵𝑎𝑠𝑒𝐿𝑜𝑡×𝐸𝑥𝑝𝑜𝑠𝑢𝑟𝑒𝑊𝑒𝑖𝑔ℎ𝑡×𝐻𝑒𝑎𝑙𝑡ℎ𝑀𝑢𝑙𝑡𝑖𝑝𝑙𝑖𝑒𝑟
Where:
...
V. Answer to Q1
Difference between Phase 2 Exposure Adjustment and
Phase 3 Lot Allocation
Phase 2
Determines:
